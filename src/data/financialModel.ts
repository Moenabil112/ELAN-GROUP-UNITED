...
export const SCENARIOS: ScenarioAssumptions[] = [
  {
    ...
    descriptionAr:
      "تحقق بطيء لقنوات الإيراد مع انضباط كامل في الإنفاق. النافذة تحافظ على استمراريتها التشغيلية، والتوزيعات محدودة، واسترداد رأس المال خارج أفق النموذج.",
  ...
  },
  {
    ...
    descriptionAr:
      "تحول تدريجي للقنوات الخمس إلى عقود خلال 12–36 شهراً، مع نمو منضبط للبرامج والخدمات. مسار استرداد رأس المال النموذجي يتضح في الثلث الأخير من الأفق.",
