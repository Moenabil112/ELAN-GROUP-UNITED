  ...
  return (
    <>
      ...
      <SectionHeader
        ...
        titleAr="ما الذي ينقص كل حزمة قبل الاعتماد؟"
        descAr="سجل موحد عبر الحزم الثماني: المدخلات الناقصة، وما يتطلب مراجعة مرخصة، وما يحتاج تحديداً أو تحديثاً، وما هو جاهز للمراجعة — لكل بند مالك وإجراء وتاريخ مستهدف مبدئيان."
      />
      <OpenItemsRegister />
      <SectionHeader
